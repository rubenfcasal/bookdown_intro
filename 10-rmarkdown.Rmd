...
El resultado dependerá del tipo de documento, si se trata de un archivo HTML se mostrará justo después de donde fué generado. 
Si se genera un documento en LaTeX (a partir del cual se obtienen los documentos PDF), 
